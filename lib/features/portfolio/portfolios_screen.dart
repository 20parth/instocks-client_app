        ...
        builder: (context, snapshot) {
          ...
          return ListView(
            ...
            children: [
              ...
              const Text(
                  'Every portfolio linked to your client profile, with capital, ROI, payment date, and maturity visibility.'),
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              Expanded(
                                  child: Text(portfolio.portfolioNumber,
                                      style: Theme.of(context)
                                          .textTheme
                                          .titleLarge
                                          ?.copyWith(
                          ...
                          Text(
                              'Invested: ${AppFormatters.currency(portfolio.initialInvestment)}'),
                          Text(
                              'Current Capital: ${AppFormatters.currency(portfolio.currentCapital)}'),
                          Text(
                              'Total ROI: ${AppFormatters.currency(portfolio.totalRoi)}'),
                          Text(
